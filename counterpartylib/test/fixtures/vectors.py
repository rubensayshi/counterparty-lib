...
UNITTEST_VECTOR = {
    ...
    'bet': {
        'validate': [{
            ...
            'in': (P2SH_ADDR[0], ADDR[0], 0, 1488000100, 2**32, DP['small'], 0.0, 15120, DP['expiration'], DP['default_block']),
            'out': ([], 15120)
        }, {
            'in': (ADDR[0], P2SH_ADDR[0], 0, 1488000100, 2**32, DP['small'], 0.0, 15120, DP['expiration'], DP['default_block']),
            'out': ([], 15120)
        }, {
        ...
        'match': [{
            ...
            'in': ({'block_hash': '46ac6d09237c7961199068fdd13f1508d755483e07c57a4c8f7ff18eb33a05c93ca6a86fa2e2af82fb77a5c337146bb37e279797a3d11970aec4693c46ea5a58',
                    'block_index': 310501, 'supported': 1,
                    'block_time': 310501000,
        ...
        #             'block_index': DP['default_block'] - 1,
    ...
    'blocks': {
        ...
        'parse_block': [{
            ...
            'out': ('8c2188fb8d1fc47ed38d2008ab36a63d395f0c68374bc2542c8e14ddfe470950',
    ...
    'cancel': {
        'compose': [{
            ...
            'in': (P2SH_ADDR[0], '3afada35d5012c10348d88ff03c7813e8ed7f06b2b259b4be6c847358b3b0a4a'),
            'out': (P2SH_ADDR[0], [], b'\x00\x00\x00F:\xfa\xda5\xd5\x01,\x104\x8d\x88\xff\x03\xc7\x81>\x8e\xd7\xf0k+%\x9bK\xe6\xc8G5\x8b;\nJ')
        }, {
            'in': (ADDR[1], 'foobar'),
    ...
    'broadcast': {
        'validate': [{
            ...
            'in': (P2SH_ADDR[0], 1588000000, 1, DP['fee_multiplier'], 'Unit Test', DP['default_block']),
            'out': ([])
        }, {
    ...
    'issuance': {
        'validate': [{
            ...
            'in': (P2SH_ADDR[0], None, 'ASSET', 1000, True, False, None, None, '', DP['default_block']),
            'out': (0, 0.0, [], 50000000, '', True, False)
        }, {
    ...
    'dividend': {
        'validate': [{
            ...
            'comment': 'only issuer can pay dividends',
            ...
            'comment': 'no such dividend asset, NOASSET',
    ...
    'order': {
        'validate': [{
            ...
            'in': (P2SH_ADDR[0], 'DIVISIBLE', DP['quantity'], 'XCP', DP['quantity'], 2000, 0, DP['default_block']),
            'out': ([])
        }, {
        ...
        'parse': [{
            ...
            'records': [
                {'table': 'orders', 'values': {
                    'block_index': DP['default_block'],
                    'expiration': 2000,
                    'expire_index': DP['default_block'] + 2000,
                    'fee_provided': 10000,
                ...
                {'table': 'order_matches', 'values': {
                    ...
                    'match_expire_index': DP['default_block'] + 20,
                    'status': 'completed',
                    'tx0_address': 'mn6q3dS2EnDUx3bmyWc6D4szJNVGtaR7zc',
                    'tx0_block_index': DP['default_block'] - 495,
                    'tx0_expiration': 2000,
                    'tx0_hash': '074fa38a84a81c0ed7957484ebe73836104d3068f66b189e05a7cf0b95c737f3',
                    'tx0_index': 7,
                    'tx1_address': 'mtQheFaSfWELRB2MyMBaiWjdDm6ux9Ezns',
                    'tx1_block_index': DP['default_block'],
                    'tx1_expiration': 2000,
            ...
            'records': [
                ...
                {'table': 'order_matches', 'values': {
                    ...
                    'status': 'pending',
                    'tx0_address': 'mn6q3dS2EnDUx3bmyWc6D4szJNVGtaR7zc',
                    'tx0_block_index': DP['default_block'] - 491,
                    'tx0_expiration': 2000,
            ...
            'records': [
                {'table': 'orders', 'values': {
                    'block_index': DP['default_block'],
                    'expiration': 10,
                    'expire_index': DP['default_block'] + 10,
                    'fee_provided': 10000,
                    'fee_provided_remaining': 1000,
                    'fee_required': 0,
                    'fee_required_remaining': 0,
