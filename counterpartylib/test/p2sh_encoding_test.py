...
def test_p2sh_encoding(server_db):
    ...
    with util_test.ConfigContext(OLD_STYLE_API=True):
        ...
        # data P2SH output
        assert repr(pretx.vout[1].scriptPubKey) == "CScript([OP_HASH160, x('2831bc3313a9c6eecab66275764f8f966da6be55'), OP_EQUAL])"
        assert pretx.vout[1].nValue == 7800
        # change output
        assert pretx.vout[2].nValue == 199909140 - 7630 - 7800 - fee
        assert pretxhex == ""
        ...
        assert len(datatxhex) / 2 == 269
        assert sumvin == 15430
        assert sumvout < sumvin
        assert sumvout == sumvin - fee
        assert len(datatx.vin) == 2
        assert bitcoinlib.core.b2lx(datatx.vin[0].prevout.hash) == pretxid
        assert datatx.vin[0].prevout.n == 0
        assert bitcoinlib.core.b2lx(datatx.vin[1].prevout.hash) == pretxid
        assert datatx.vin[1].prevout.n == 1
        ...
        assert datatxhex == ""
